            ...
            <div className="article-grid">
              <div>
                ...
                <div style={{display:"flex", margin:"15px"}}>
                  <div className="grid-item1" style={{position:"relative", marginTop:"12%"}}> 
                    <img src="./images/Taj-mahal.jpg" alt=""  width="100%" height="75%" />
                    <div class="centered" style={{position:"absolute", top:"40%", left:"40%", textAlign:"center"}} >
